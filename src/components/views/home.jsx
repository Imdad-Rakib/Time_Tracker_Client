...
export default function Home(){
    ...
    const createEntry = async () =>{
        ...
        try{
            let response = await fetch('http://localhost:8000/timeTracking/newEntry', {
                method: 'POST',
                headers: {
    ...
    const editRequest = async () =>{
        try {
            let response = await fetch(`http://localhost:8000/timeTracking/updateReq/${editDate}`, {
                method: 'GET',
                credentials: 'include'
            })
            response = await response.json();
    ...
    const editEntry = async () =>{
        ...
        try {
            let response = await fetch('http://localhost:8000/timeTracking/updateEntry', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const deleteEntry = async () =>{
        try {
            let response = await fetch(`http://localhost:8000/timeTracking/deleteEntry/${deleteDate}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                },
